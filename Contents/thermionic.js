...
var hr, mn, se, dt, mnth, yr,
    ...
    var widgetName = "Cyberpunk Nixie Tube Clock.widget";

        var windowx = 1696, windowy = 800;
        
        var leftHourIndicatoryo = 0, leftHourIndicatorxo = 10;
        var rightHourIndicatoryo = 0, rightHourIndicatorxo = 239;
        var leftMinuteIndicatoryo = 0, leftMinuteIndicatorxo = 534;
        var rightMinuteIndicatoryo = 0, rightMinuteIndicatorxo = 773;
        var leftSecondIndicatoryo = 0, leftSecondIndicatorxo = 1077;
        var rightSecondIndicatoryo = 0, rightSecondIndicatorxo = 1316;
        
        var bgimage1yo = 0, bgimage1xo = 10;
        var bgimage2yo = 0, bgimage2xo = 239;
        var bgimage3yo = 0, bgimage3xo = 534;
        var bgimage4yo = 0, bgimage4xo = 773;
        var bgimage5yo = 0, bgimage5xo = 1077;
        var bgimage6yo = 0, bgimage6xo = 1316;
        
        var pinxo = 370 , pinyo = 411;
